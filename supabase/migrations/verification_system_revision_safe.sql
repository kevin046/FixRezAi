-- =====================================================
-- SUPABASE VERIFICATION SYSTEM REVISION - SAFE MIGRATION
-- Handles existing data and applies constraints gradually
-- =====================================================

-- =====================================================
-- PHASE 1: Add columns without constraints first
-- =====================================================

-- 1.1 Add enhanced verification fields to profiles table (no constraints yet)
...
-- 1.2 Clean up existing data to prepare for constraints
-- Set verified=false where null to prepare for constraint
...
-- =====================================================
-- PHASE 2: Create verification tokens table
-- =====================================================
...
-- =====================================================
-- PHASE 3: Create error handling system
-- =====================================================
...
-- =====================================================
-- PHASE 4: Create core verification functions
-- =====================================================
...
-- =====================================================
-- PHASE 5: Add constraints after data cleanup
-- =====================================================

-- 5.1 Add check constraints for method field
ALTER TABLE profiles
ADD CONSTRAINT profiles_verification_method_check 
    CHECK (verification_method IS NULL OR verification_method IN ('email', 'phone', 'admin'));

-- 5.2 Add constraints for verified users only (this should be safe now)
ALTER TABLE profiles
...
-- 5.3 Add constraints for attempt fields
ALTER TABLE profiles
...
-- 6.3 Verification tokens policies
...
-- 6.4 Error messages policies (read-only for all)
