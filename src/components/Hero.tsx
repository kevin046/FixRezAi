...
import { Medal, Star, Sparkles, FileText, Download, ArrowRight, Linkedin, Twitter, Instagram, Facebook, Home, LayoutDashboard, Settings, Menu, X, ChevronRight } from "lucide-react";
